...
import type { Basins } from './basins';
...
export interface World extends SurfaceWorld { tectonics: Tectonics; crust: Crust; terrain: Terrain; water: Water; drainage: Drainage; basins: Basins }
