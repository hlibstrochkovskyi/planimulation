...
Next: prescribed-input filling experiments on controlled bowls. Define independent inventories, neighbor receiving paths, fill/merge behavior, and explicit input/storage/outflow budgets before claiming dynamic lakes or rivers. Preserve existing water stock when assigning initial reservoirs; do not repeatedly refit a global water-coverage target.
